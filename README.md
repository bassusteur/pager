This project is what i think an ideal portable pager would be like, powered by a risc-v core inside the ESP32-C6 on-board, it features a pretty standard interface for a pager: except for the 
